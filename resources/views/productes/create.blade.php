            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('productes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcio" id="descripcio" class="w-full border-gray-300 rounded-lg"></textarea>
                    </div>

                    <div class="mb-4">
                        <label for="preu" class="block text-gray-700">Preu</label>
                        <input type="number" name="preu" id="preu" class="w-full border-gray-300 rounded-lg" step="0.01" required>
                    </div>

                    <div class="mb-4">
                        <label for="quantitat_stock" class="block text-gray-700">Quantitat en stock</label>
                        <input type="number" name="quantitat_stock" id="quantitat_stock" class="w-full border-gray-300 rounded-lg" required>
                    </div>
